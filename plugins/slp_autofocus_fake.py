...
img = cv2.imread("hologram_cell_curved_bg.jpg", cv2.IMREAD_GRAYSCALE)
...
class AutofocusFakePlugin(ShapeLinkPlugin):
    ...
    def handle_event(self, event_data):
        ...
        # send image but use the loaded (cropped) hologram
        # open with qpimage (or correct program)
        # get phase
        # use nrefocus to autofocus it
        # get direction and magnitude of defocus needed
        # how to pass this value to another program?

        qpi = qpimage.QPImage(data=img_crop, which_data="hologram")
        field = qpi.field
        ...
        # this vaue must first be calibrated with the z-stage
